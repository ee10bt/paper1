...
Conductivity values are obtained from each integral by averaging between correlation time of 2-10~ps. We show in Figure \ref{fig:acf_decay} that the magnitude of the ACF decays to much less than 1\% of its initial value around 1~ps, which should mean convergence of the integral and thus conductivity. %We stop averaging the integral after correlation time of 10~ps, despite having data for 100~ps. 
